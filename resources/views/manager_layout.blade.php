...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Product Manager Pannel</title>
	...
	<!-- start: Favicon -->
	<link rel="shortcut icon" href="{{URL::to('backend/img/settings.png')}}">
	<!-- end: Favicon -->
...
<body>
		<!-- start: Header -->
	<div class="navbar">
		<div class="navbar-inner-manager">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/manager-page')}}"><span>Ni-Biz-Manager</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{URL::to('/manager-logout')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="{{URL::to('/manager-page')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						...
						<?php
                            ...
                            ->get();
                            $previous=count($all_order_count);

                            $all_visitor=DB::table('tbl_viewer')
                			->where('viewer_id',1)
                            ->get();
                            foreach($all_visitor as $v_visitor)
                            $next=$v_visitor->notification;
                        	$new= $previous-$next;
            			?>
						<li><a href="{{URL::to('/manager-manage-order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Order</span><span class="label label-important"> <?php echo  $new;?></span></a></li>
						<li><a href="{{URL::to('/bkash-payment')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Bkash Payment</span><span class="label label-important"></span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="http://bootstrapmaster.com/" alt="Bootstrap Themes">NI-BIZ</a></span>
			<span class="hidden-phone" style="text-align:right;float:right">Developed by: <a href="" alt="Bootstrap Admin Templates">Fakhrul</a></span>
		</p>
