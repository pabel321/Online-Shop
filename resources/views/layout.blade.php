                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            ...
                            <?php if($customer_id != NULL) {?>
                                <li><a href="{{URL::to('/all-wishlist')}}"><i class="fa fa-star"></i> Wishlist</a></li>
                            <?php } else {?>  
                            <?php } ?>
                    ...
                    <div class="col-sm-3">
                        <form action="{{URL::to('/search')}}" method="post" role="search">
                            ...
                            <div class="search_box pull-right">
                                <input type="text"  id="searchname"  name="search" placeholder="Search"/>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="companyinfo">
                            <h2><span>Ecommerce</span>-Shopping</h2>
